...
price_info = (diff_price_plus_avg, diff_price_plus_max, diff_price_plus_min, diff_price_plus_std)
...
x_axis = ('plus_avg : {} '.format(diff_price_plus_avg),
          'plus_max : {} '.format(diff_price_plus_max),
          'plus_min : {} '.format(diff_price_plus_min),
          'plus_std : {} '.format(diff_price_plus_std),
          )
...
# performance = np.asarray([diff_price_plus_avg, diff_price_minus_avg])
# print(performance)
# error = np.asarray([diff_price_plus_std, diff_price_minus_std])
# print(error)
#
...
# axes.set_xlabel('fluctuation')
# axes.set_ylabel('product_price')
#
# # add x-tick labels
